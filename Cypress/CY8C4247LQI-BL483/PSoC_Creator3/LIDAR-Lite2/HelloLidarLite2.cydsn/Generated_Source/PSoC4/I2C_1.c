...
static void I2C_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void I2C_1_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[I2C_1_RX_SDA_MOSI_PIN_INDEX] = I2C_1_HSIOM_I2C_SEL;
            hsiomSel[I2C_1_TX_SCL_MISO_PIN_INDEX] = I2C_1_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[I2C_1_RX_SDA_MOSI_PIN_INDEX] = I2C_1_HSIOM_SPI_SEL;
            hsiomSel[I2C_1_TX_SCL_MISO_PIN_INDEX] = I2C_1_HSIOM_SPI_SEL;
            hsiomSel[I2C_1_CTS_SCLK_PIN_INDEX] = I2C_1_HSIOM_SPI_SEL;
            ...
            if (I2C_1_SPI_SLAVE == subMode)
            {
                ...
                hsiomSel[I2C_1_RTS_SS0_PIN_INDEX] = I2C_1_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[I2C_1_TX_SCL_MISO_PIN_INDEX] = I2C_1_HSIOM_UART_SEL;
                pinsDm  [I2C_1_TX_SCL_MISO_PIN_INDEX] = I2C_1_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[I2C_1_RX_SDA_MOSI_PIN_INDEX] = I2C_1_HSIOM_UART_SEL;
                    pinsDm  [I2C_1_RX_SDA_MOSI_PIN_INDEX] = I2C_1_PIN_DM_DIG_HIZ;
                }
                ...
                if (I2C_1_UART_MODE_STD == subMode)
                {
                    if (0u != (I2C_1_UART_CTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[I2C_1_CTS_SCLK_PIN_INDEX] = I2C_1_HSIOM_UART_SEL;
                        pinsDm  [I2C_1_CTS_SCLK_PIN_INDEX] = I2C_1_PIN_DM_DIG_HIZ;
                    }
                    ...
                    if (0u != (I2C_1_UART_RTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[I2C_1_RTS_SS0_PIN_INDEX] = I2C_1_HSIOM_UART_SEL;
                        pinsDm  [I2C_1_RTS_SS0_PIN_INDEX] = I2C_1_PIN_DM_STRONG;
